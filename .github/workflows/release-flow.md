...
2. The workflow triggered by the previous step automatically performs the following:
...
6. Manually review and update the draft GitHub Release, then publish it.
