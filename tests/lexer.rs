...
fn do_tokenize_single_token(input: &str, expected_kind: TokenKind, expected_line: usize, expected_column: usize) -> Result<()> {
...
fn tokenize_left_bracket() -> Result<()> {
    do_tokenize_single_token("[", TokenKind::LeftBracket, 1, 1)
}

#[test]
fn tokenize_right_bracket() -> Result<()> {
    do_tokenize_single_token("]", TokenKind::RightBracket, 1, 1)
}

#[test]
fn tokenize_left_brace() -> Result<()> {
    do_tokenize_single_token("{", TokenKind::LeftBrace, 1, 1)
}

#[test]
fn tokenize_right_brace() -> Result<()> {
    do_tokenize_single_token("}", TokenKind::RightBrace, 1, 1)
}

#[test]
fn tokenize_colon() -> Result<()> {
    do_tokenize_single_token(":", TokenKind::Colon, 1, 1)
}

#[test]
fn tokenize_comma() -> Result<()> {
    do_tokenize_single_token(",", TokenKind::Comma, 1, 1)
}

#[test]
fn tokenize_true() -> Result<()> {
    do_tokenize_single_token("true", TokenKind::Boolean(true), 1, 1)
}

#[test]
fn tokenize_false() -> Result<()> {
    do_tokenize_single_token("false", TokenKind::Boolean(false), 1, 1)
}

#[test]
fn tokenize_null() -> Result<()> {
    do_tokenize_single_token("null", TokenKind::Null, 1, 1)
}
...
fn skip_line_feed() -> Result<()> {
    do_tokenize_single_token("\n:", TokenKind::Colon, 2, 1)
}

#[test]
fn skip_carrige_return() -> Result<()> {
    do_tokenize_single_token("\r:", TokenKind::Colon, 1, 2)
}

#[test]
fn tokenize_invalid_char() -> Result<()> {
    let s = ".";
    do_tokenize_single_token(s, TokenKind::Invalid(s.to_string()), 1, 1)
}
